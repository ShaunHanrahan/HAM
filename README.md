...
- **Works on phones.** On small screens the sidebar becomes a bottom sheet. Swipe or tap the grabber to expand it, and the whole thing scrolls as one list so you're not hunting through nested panes. Follow a satellite and its details lead the sheet automatically. Drag with one finger to rotate the globe, pinch with two to zoom, and the rotation speed now tracks your finger at any zoom level instead of racing when you're zoomed in.
